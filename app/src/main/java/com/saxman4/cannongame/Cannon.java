...
public class Cannon {
   ...
   public void draw(Canvas canvas) {
      ...
      canvas.drawCircle(0, (int) view.getScreenHeight() / 2,
       ...
       // saxman4 - draw cannonball path if cannonball was fired, and hasn't hit a blocker;
       // We will draw a red dashed line to trace the path of the cannonball;
       if ((cannonball != null) && (cannonball.velocityX > 0)) {
           ...
           paint.setStrokeWidth(this.barrelWidth); // reset sroke to barrel width
