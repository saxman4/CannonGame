...
package com.saxman4.cannongame;
...
public class CannonView extends SurfaceView
   ...
   private int highScore; // highest score reached

   // constants and variables for managing sounds
   public static final int TARGET_SOUND_ID = 0;
   public static final int CANNON_SOUND_ID = 1;
   public static final int BLOCKER_SOUND_ID = 2;
   public static final int EDGE_SOUND_ID = 3; // saxman4
   ...
   public CannonView(Context context, AttributeSet attrs) {
      ...
      // saxman4 - change max num of streams from 1 to 10 - 9 targets hitting wall plus
      // 1 target collision or 1 blocker collision - otherwise the target or blocker
      // collision sounds will be clipped by the wall collision
      ...
      // saxman4 - add sound for when target hits edge of screen
      soundMap.put(EDGE_SOUND_ID,
              soundPool.load(context, R.raw.fishing_rod_whoosh, 1));
   ...
   // saxman4 - initialize score and level
   ...
   public void newGame() {
      ...
      // saxman4 - if last game lost, reset score and level
      if (timeLeft <= 0) {
         resetScore();
      }
      else {
         level = level + 1;
         if (score > highScore) {
            highScore = score; // record highest score
         }
      }
         ...
         new DialogFragment() {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
               ...
               builder.setMessage(getResources().getString(
                  R.string.results_format, shotsFired, totalElapsedTime, score, level)); // saxman4
