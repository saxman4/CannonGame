...
public class Cannonball extends GameElement {
   // saxman4 - make velocityX public so we won't print dashed line after cannonball hits blocker;
   // We can check to see if cannonball bounced if velocityX is negative, and then we can
   // stop printing dotted line, because otherwise the whole line will move and look wrong,
   // because it will no longer trace the path of the bouncing cannonball.
